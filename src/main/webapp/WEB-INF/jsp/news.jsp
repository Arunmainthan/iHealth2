                ...
                if (newsSearch.results && newsSearch.results.length > 0) {
                    ...
                    for (var i = 0; i < newsSearch.results.length; i++) {
                        ...
                        var cont = '<div class="alert alert-dismissable alert-warning" style="background-color: #ebebeb;color:#000;">'
                            ...
                            +'<br/><button style="color:#000;" class="fb-like" onclick="post_on_wall('+newshot+');">Post on FB</button><br/><a href="https://twitter.com/share" class="twitter-share-button"  data-text="'+news_content.substring(0, 136)+'" data-url="" data-lang="en">Tweet</a></div>'
                            +'';
